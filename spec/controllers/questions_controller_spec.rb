...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET edit" do
     ...
     it "assigns question to be updated to @question" do
       ...
       expect(question_instance.id).to eq question_instance.id
       expect(question_instance.title).to eq question_instance.title
       expect(question_instance.body).to eq question_instance.body
     end
   end
   ...
   describe "PUT update" do
     it "updates question with expected attributes" do
       ...
       expect(updated_question.id).to eq updated_question.id
